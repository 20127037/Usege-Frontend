...
@ActivityScoped
public class AlbumServiceGenerator extends BaseAuthServiceGenerator<AlbumService> {
    @Inject
    public AlbumServiceGenerator(@ApplicationContext Context context, TokenRepository tokenRepository) {
        super(tokenRepository, context.getResources(), R.string.api_version, R.string.service_album);
    }
